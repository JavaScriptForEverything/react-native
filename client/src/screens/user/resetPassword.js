...
import { resetPassword } from '../../store/userReducer'
...
const inputItems = [
  { label: 'Token', name: 'token',  icon: 'key' },
...
const ResetPasswordScreen = () => {
  ...
  const { error, loading, resetPasswordMessage } = useSelector(state => state.user)
    ...
    <Layout>
      <ScrollView style={styles.container}>
        ...
        <TouchableOpacity onPress={submitHandler} >
          <Button mode='contained' loading={loading} style={styles.submitButton}>Reset Password</Button>
        </TouchableOpacity>
